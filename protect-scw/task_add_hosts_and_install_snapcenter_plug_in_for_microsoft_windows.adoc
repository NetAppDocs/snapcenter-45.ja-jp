...
+
link:task_configure_gMSA_on_windows_server_2012_or_later_for_windows_file_system.html["Windows ファイルシステム用に、 Windows Server 2012 以降のグループマネージドサービスアカウントを設定します"]
